...
namespace CommonPart {
    ...
    class DataBase : IDisposable
    {
        ...
        public static void setupSkillData()
        {
            ...
            addSkillData(new WayShotSkillData("boss1downshot-0",hppOverFifty, SkillGenreS.wayshot, "bulletsmall", low_cd1, MoveType.go_straight,PointType.selfDirection,nv,0, middle_speed1, 0, -lowangle1, 0, small_radius));
            addSkillData(new WayShotSkillData("boss1downshot-1", hppOverFifty, SkillGenreS.wayshot, "bulletsmall", low_cd1, MoveType.go_straight, PointType.selfDirection, nv, 0, middle_speed1, 0.0, -Math.PI/4, 0, small_radius));
